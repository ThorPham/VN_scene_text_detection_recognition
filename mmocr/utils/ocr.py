...
def parse_args():
    ...
    parser.add_argument(
        'img', 
        type=str,
        # default='/home/thorpham/Documents/challenge/TestA',
    ...
    parser.add_argument(
        '--det-config',
        type=str,
        default='/home/thorpham/Documents/challenge/mmocr/dbnet_train_more/dbnet_r50dcnv2_fpnc_1200e_icdar2015.py',
        help='Path to the custom config file of the selected det model. It '
        'overrides the settings in det')
    parser.add_argument(
        '--det-ckpt',
        type=str,
        default='/home/thorpham/Documents/challenge/mmocr/dbnet_train_more/epoch_20.pth',
    ...
    parser.add_argument(
        '--recog-config',
        type=str,
        default='/home/thorpham/Documents/challenge/mmocr/satrnnet/satrn_academic.py',
        help='Path to the custom config file of the selected recog model. It'
        'overrides the settings in recog')
    parser.add_argument(
        '--recog-ckpt',
        type=str,
        default='/home/thorpham/Documents/challenge/mmocr/satrnnet/epoch_4.pth',
    ...
    parser.add_argument(
        '--export',
        type=str,
        default='/home/thorpham/Documents/challenge/mmocr/outputs/out',
...
class MMOCR:
    ...
    def __init__(self,
        ...
        textrecog_models = {
            ...
            'SATRN_sm': {
                ...
                'config': '/home/thorpham/Documents/challenge/mmocr/satrnnet/satrn_academic.py',
                'ckpt': '/home/thorpham/Documents/challenge/mmocr/satrnnet/epoch_4.pth'
            },
            'SEG': {
            ...
            if output or args.imshow:
                if self.kie_model:
                    ...
                    res_img = det_recog_show_result(
                        arr, det_recog_result, out_file=output,save_txt=export)
    ...
    def det_recog_kie_inference(self, det_model, recog_model, kie_model=None):
        ...
        for filename, arr, bboxes, out_file in zip(self.args.filenames,
            ...
            for bbox in bboxes:
                ...
                box_img = crop_img(arr, box,long_edge_pad_ratio=0.01,short_edge_pad_ratio=0.01)
    ...
    def _args_processing(self, args):
        ...
        if isinstance(img_list[0], str):
            args.filenames = [str(os.path.basename(x)) for x in img_list]
        else:
        ...
        if args.output:
            ...
            if output_path.is_dir():
                args.output = [
                    str(output_path / f'{x}') for x in args.filenames
                ]
            else:
